...
export default async function translate(
  ...
  const prompt = `Translate the following (only return the translated answer, nothing else) from the locale '${options.fromLocale}' to the locale '${options.toLocale}': ${string}`
